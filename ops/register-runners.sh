#!/usr/bin/env bash
# Operator wrapper for the register-runners flow. This entry owns one
# concern the bridge intentionally does not:
#
...
# (CA_NEEDS_HOST_FILE_SERVER=1). The deregister entry omits the file server
# because its down path fetches nothing.
#
